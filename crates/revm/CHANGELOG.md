...
## [41.0.1](https://github.com/0xMars42/revm/compare/revm-v41.0.0...revm-v41.0.1) - 2026-06-12

### Other

- updated the following local packages: revm-database-interface, revm-database, revm-context-interface, revm-context, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-statetest-types
