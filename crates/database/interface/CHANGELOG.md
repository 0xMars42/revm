...
## [42.0.0](https://github.com/0xMars42/revm/compare/revm-database-interface-v41.0.0...revm-database-interface-v42.0.0) - 2026-06-12

### Added

- *(database)* add database fallback mode for BAL misses ([#3754](https://github.com/0xMars42/revm/pull/3754))
